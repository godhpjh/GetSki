...
import com.getski.security.CustomUserDetailsService;
import com.getski.security.SimpleCorsFilter;
import com.getski.security.jwt.JwtAuthenticationEntryPoint;
import com.getski.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers("/api/ski/**", "/api/register/**", "/api/comment/**")
                .permitAll()
                .antMatchers("/", "/error", "/api/authenticate/**", "/oauth/**", "/oauth2/**", "/h2-console/**",
