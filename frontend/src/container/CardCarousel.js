...
import CustomCardSlide from "../component/Carousel/CustomCardSlide";
import CustomDotGroup from "../component/Carousel/CustomDotGroup";

class CardCarousel extends React.Com {
  render() {
    return (
      <CarouselProvider
    naturalSlideWidth={1}
